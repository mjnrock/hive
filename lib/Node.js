...
var Node = function (_EventEmitter) {
    ...
    function Node() {
        ...
        _this._effects = new Set(effects);
        _this._config = {
    ...
    _createClass(Node, [{
        ...
        value: function onMessage(msg) {
            ...
            if (this.config.isSelfMessaging && msg.emitter.id === this.id || msg.emitter.id !== this.id) {
                ...
                var _arr = [].concat(_toConsumableArray(this._effects));
        ...
        value: function addEffect() {
            ...
            if (arguments.length === 1) {
                ...
                var _arguments2 = Array.prototype.slice.call(arguments),
                    type = _arguments2[0],
                    _effect = _arguments2[1];

                if (typeof _effect === "function") {
                    this._effects.add(function (state, msg) {
                        if (msg.type === type) {
                            return _effect.call(_this2, state, msg);
                        }

...
var GridCanvasNode = function (_CanvasNode) {
    ...
    _createClass(GridCanvasNode, [{
        ...
        key: "gCircle",
        value: function gCircle(x, y, r) {
            var _ref7 = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {},
                _ref7$isFilled = _ref7.isFilled,
                isFilled = _ref7$isFilled === undefined ? false : _ref7$isFilled,
                round = _ref7.round;

            var _pixelToGrid5 = this.pixelToGrid([x], [y], { round: round, asArray: true }),
                _pixelToGrid6 = _slicedToArray(_pixelToGrid5, 2),
                _pixelToGrid6$ = _slicedToArray(_pixelToGrid6[0], 1),
                tx = _pixelToGrid6$[0],
                _pixelToGrid6$2 = _slicedToArray(_pixelToGrid6[1], 1),
                ty = _pixelToGrid6$2[0];

            this.circle(tx, ty, r, { isFilled: isFilled });
        ...
        value: function gTile(imageOrSrc, sx, sy, dx, dy) {
            ...
            var _pixelToGrid7 = this.pixelToGrid([sx, dx], [sy, dy], { round: round, asArray: true }),
                _pixelToGrid8 = _slicedToArray(_pixelToGrid7, 2),
                _pixelToGrid8$ = _slicedToArray(_pixelToGrid8[0], 2),
                tsx = _pixelToGrid8$[0],
                tdx = _pixelToGrid8$[1],
                _pixelToGrid8$2 = _slicedToArray(_pixelToGrid8[1], 2),
                tsy = _pixelToGrid8$2[0],
                tdy = _pixelToGrid8$2[1];
